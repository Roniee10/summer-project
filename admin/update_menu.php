                    ...
                    if (
                        ...
                        if (
                            ...
                            if ($fsize >= 1000000) {
                                ...
                                $sql = "update dishes set rs_id='$_POST[res_name]',title='$_POST[d_name]',stock='$_POST[stock]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
                                mysqli_query($db, $sql);
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="d_name" value="<?php echo $roww[
                                                                    'title'
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" name="about" value="<?php echo $roww[
                                                                    'slogan'
