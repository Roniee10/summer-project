...
<body class="fix-header">
    ...
    <a class="nav-link dropdown-toggle text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <img src="images/bookingSystem/user-icn.png" alt="user" class="profile-pic img-fluid" style="max-height: 200px;" />
    </a>
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php
                                            $sql =
                                                "select * from users_orders WHERE status = 'in process' ";
                                            $result = mysqli_query($db, $sql);
                                            $rws = mysqli_num_rows($result);
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php
                                            $sql =
                                                "select * from users_orders WHERE status = 'closed' ";
                                            $result = mysqli_query($db, $sql);
                                            $rws = mysqli_num_rows($result);
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php
                                            $sql =
                                                "select * from users_orders WHERE status = 'rejected' ";
                                            $result = mysqli_query($db, $sql);
                                            $rws = mysqli_num_rows($result);
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            ...
                                            $result = mysqli_query(
                                                $db,
                                                'SELECT SUM(price) AS value_sum FROM users_orders WHERE status = "closed"'
                                            );
